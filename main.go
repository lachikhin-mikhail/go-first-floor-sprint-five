...
func (t Training) distance() float64 {
	...
	distance := action * t.LenStep / MInKm
	return distance
}
...
func (w Walking) Calories() float64 {
	...
	calories := (CaloriesWeightMultiplier*weight + math.Pow(speedMS, 2)/heightM*CaloriesSpeedHeightMultiplier*weight) * duration * MinInHours
	return calories
}
